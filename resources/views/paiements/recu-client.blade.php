...
<div class="d-flex gap-2 mb-4 no-print justify-content-center flex-wrap">
    ...
    <a href="{{ route('paiements.index') }}" class="btn btn-outline-secondary px-4">
        ← Retour
    </a>
</div>
...
<div id="ticketWrapper">
    ...
    <div class="rt-row"><span>Date</span><b>{{ $dateImpression }}</b></div>
...
(function() {
    ...
    var dateImp     = @json($dateImpression);
    ...
    // ── Génération QR synchrone (qrcode-generator, même lib que React Native)
    (function() {
    ...
    document.getElementById('btnWhatsApp').addEventListener('click', async function() {
        ...
        // Essai partage natif avec image (Android/iOS)
