...
<style>.permission-check{border:1px solid #dee2e6;border-radius:8px;padding:12px 12px 12px 38px;min-height:70px;background:#fff}.permission-check:has(.form-check-input:checked){background:#eef5ff;border-color:#0d6efd}</style>
